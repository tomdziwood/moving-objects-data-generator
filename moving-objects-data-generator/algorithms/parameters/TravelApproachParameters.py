...
class TravelApproachParameters(StandardTimeFrameParameters):
    ...
    def __init__(
        ...
        step_length_mean : float
            ...
            with the lambda equals ``step_length_mean``.
        ...
        step_length_method : StepLengthMethod
            ...
            For the detailed description of the available values, see `StepLengthMethod` enum class documentation.
        ...
        step_angle_range_mean : float
            ...
            of the Poisson distribution with the lambda equals ``step_angle_range_mean``.
        ...
        step_angle_normal_std_ratio : float
            ...
            of a normal distribution to the range of the step's angle. This ratio is applied across all features types.
