...
def main():
    ...
    generate(output_file="SpatialBasicGenerator_output_file.txt", area=1000, cell_size=5, n_base=2, lambda_1=5, lambda_2=100, m_clumpy=1, m_overlap=3, ncfr=0.4, ncfn=1, ncf_proportional=False, ndf=5, ndfn=200, random_seed=0)
