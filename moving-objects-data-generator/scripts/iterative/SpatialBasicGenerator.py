...
def generate(output_file="SpatialBasicGenerator_output_file.txt", area=1000.0, cell_size=5.0, n_base=3, lambda_1=5.0, lambda_2=100.0, m_clumpy=1, m_overlap=1, ncfr=1.0, ncfn=1.0, ncf_proportional=False, ndf=2, ndfn=5000, random_seed=None):
    ...
    if ndf > 0:
        ...
        for _ in range(ndfn):
            ...
            f.write("%d;%d;%.6f;%.6f\n" % (collocation_start_feature_id + additional_noise_feature, additional_noise_feature_instance[additional_noise_feature], instance_x, instance_y))
...
def main():
    ...
    generate(output_file="SpatialBasicGenerator_output_file.txt", area=1000.0, cell_size=5.0, n_base=2, lambda_1=5.0, lambda_2=100.0, m_clumpy=1, m_overlap=3, ncfr=0.4, ncfn=1.0, ncf_proportional=False, ndf=5, ndfn=200, random_seed=0)
