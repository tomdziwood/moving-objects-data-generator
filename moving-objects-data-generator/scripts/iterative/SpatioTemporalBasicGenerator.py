...
def generate(output_file="SpatioTemporalBasicGenerator_output_file.txt", time_frames_number=10, area=1000.0, cell_size=5.0, n_base=3, lambda_1=5.0, lambda_2=100.0, m_clumpy=1, m_overlap=1, ncfr=1.0, ncfn=1.0, ncf_proportional=False, ndf=2, ndfn=5000, random_seed=None):
    print("generate()")
