...
def generate(output_file="SpatialBasicGenerator_output_file.txt", area=1000.0, cell_size=5.0, n_base=3, lambda_1=5.0, lambda_2=100.0, m_clumpy=1, m_overlap=1, ncfr=1.0, ncfn=1.0, ncf_proportional=False, ndf=2, ndfn=5000, random_seed=None):
    print("generate()")
    ...
    # generate vectors of x and y coordinates and ids of all consecutive instances of co-location noise features
    ...
    # generate additional noise features if they are requested
    if ndf > 0:

        # generate vectors of all necessary additional noise features data
...
def main():
    ...
    generate(output_file="SpatialBasicGenerator_output_file.txt", area=1000.0, cell_size=5.0, n_base=2, lambda_1=5.0, lambda_2=100.0, m_clumpy=2, m_overlap=3, ncfr=0.4, ncfn=1.0, ncf_proportional=False, ndf=5, ndfn=200, random_seed=0)
