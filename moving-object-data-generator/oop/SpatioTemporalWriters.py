...
class SpatioTemporalWriter:
    ...
    def write(
        ...
        as the params of the method - five vectors of #todo equal length.
...
def write_all_attributes_values(f: TextIO, parameters: StandardParameters):
    """
...
def write_standard_initiation_values(f: TextIO, si: StandardInitiation):
    """
    Write all crucial data initiated by `StandardInitiation` object.
